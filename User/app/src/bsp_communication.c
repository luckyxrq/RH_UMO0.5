...
void bsp_FillReportFrame(void)
{
	...
	reportFrame.left_wheel_velocity = bsp_MotorGetSpeed(MotorLeft) ;  		//左轮电机速度
	reportFrame.right_wheel_veloctiy = bsp_MotorGetSpeed(MotorRight) ;		//右轮电机速度
	...
	reportFrame.infrared_adc_value1 =  bsp_GetInfraRedAdcVoltage(IR0)*100;  //红外ADC值1	 
	reportFrame.infrared_adc_value2 =  bsp_GetInfraRedAdcVoltage(IR1)*100;  //红外ADC值2	 
	reportFrame.infrared_adc_value3 =  bsp_GetInfraRedAdcVoltage(IR2)*100;  //红外ADC值3	 
	reportFrame.infrared_adc_value4 =  bsp_GetInfraRedAdcVoltage(IR3)*100;  //红外ADC值4	 
	reportFrame.infrared_adc_value5 =  bsp_GetInfraRedAdcVoltage(IR4)*100;  //红外ADC值5	 
	reportFrame.infrared_adc_value6 =  bsp_GetInfraRedAdcVoltage(IR5)*100;  //红外ADC值6	 
	reportFrame.infrared_adc_value7 =  bsp_GetInfraRedAdcVoltage(IR6)*100;  //红外ADC值7	 
	reportFrame.infrared_adc_value8 =  bsp_GetInfraRedAdcVoltage(IR7)*100;  //红外ADC值8	 
	reportFrame.infrared_adc_value9 =  bsp_GetInfraRedAdcVoltage(IR8)*100;  //红外ADC值9	 
	reportFrame.infrared_adc_value10 = bsp_GetInfraRedAdcVoltage(IR9)*100;  //红外ADC值10
	...
	reportFrame.timestamp = xTaskGetTickCount();                            //时间戳
