    ...
    switch(collision_left_rightrun_step_status)
    {
		...
		case TURN_CLCOK_TARGET_YAW_LESS_ABS15_COLLISION_CL_DRYL:
			...
			if (my_abs(turn_start_x - current_pose->x) > second_turn_backward_distance ||my_abs(turn_start_y - current_pose->y) > second_turn_backward_distance)
			{
				...
				angular_velocity = 0;
				bow_continue = true;
				collision_right_rightrun_step_status = TURN_CLCOK_TARGET_YAW_LESS_ABS15_CL_DRYL;
				turn_start_update = 0;
				break;
			}
			break;
		...
		case TURN_CLCOK_TARGET_YAW_MORE_ABS15_COLLISION_CL_DRYL:
			...
			if (my_abs(turn_start_x - current_pose->x) > second_turn_backward_distance ||my_abs(turn_start_y - current_pose->y) > second_turn_backward_distance)
			{
				...
				angular_velocity = 0;
				bow_continue = true;
				collision_right_rightrun_step_status = TURN_CLCOK_TARGET_YAW_MORE_ABS15_CL_DRYL;
				turn_start_update = 0;
				break;
			}
			break;
    ...
    switch(right_reverse_walk_edge_status)
    {
        ...
        case TURN_CCLOCK_TARGET_YAW_LESS_ABS63_RWE                          :
            ...
            if (obstacleSignal == front_obstacle || obstacleSignal == left_obstacle || obstacleSignal == right_obstacle)
            {
                linear_velocity = 0;
                angular_velocity = 0;
                right_walk_edge_status = TURN_CCLOCK_TARGET_YAW_LESS_ABS63_COLLISION_RWE;
                break;
            }
            break;                                                
        ...
        case READY_GOSTR_BYPASS_RWE                                         :
            ...
            last_position_yy = 0;
            temporary_close_edge = close_edge;
            right_walk_edge_status = GOSTR_BYPASS_RWE_X;
            break;
        ...
        case GOSTR_BYPASS_RWE                                               :
            ...
            if (obstacleSignal == front_obstacle || obstacleSignal == right_obstacle || obstacleSignal == left_obstacle)
            {
                right_walk_edge_status = COLLISION_BYPASS_RWE;
                break;
            }
            if (my_abs(last_position_x - current_pose->x) > lateral_move_distance)
            {
        ...
        case TURN_CCLOCK_YAW_ADD_ABS15_RWE                                  :
            ...
            if (obstacleSignal == front_obstacle || obstacleSignal == left_obstacle || obstacleSignal == right_obstacle)
            {
                linear_velocity = 0;
                angular_velocity = 0;
                right_walk_edge_status = TURN_CCLOCK_YAW_ADD_ABS15_COLLISION_RWE;
                break;
            }
            break;                                        
        ...
        case TURN_CCLOCK_YAW_MORE_178ABS_RWE                                :
            ...
            if (obstacleSignal == front_obstacle || obstacleSignal == left_obstacle || obstacleSignal == right_obstacle)
            {
                right_walk_edge_status = TURN_CCLOCK_YAW_MORE_178ABS_COLLISION_RWE;
            }
            linear_velocity = 0;
            angular_velocity = -turn_vel;
            break;                                          
        ...
        case TURN_CLOCK_TARGET_YAW_LESS_0_RWE                 :
            ...
            if (obstacleSignal == front_obstacle || obstacleSignal == left_obstacle || obstacleSignal == right_obstacle)
            {
                linear_velocity = 0;
                angular_velocity = 0;
                right_walk_edge_status = TURN_CLOCK_TARGET_YAW_LESS_0_COLLISION_RWE;
                break;
            }
            break;                                                         
        ...
        case TURN_CLOCK_TARGET_YAW_LESS_ABS45_DETAL_YAW_MORE_30_RWE         :
            ...
            if (obstacleSignal == front_obstacle || obstacleSignal == left_obstacle || obstacleSignal == right_obstacle)
            {
                linear_velocity = 0;
                angular_velocity = 0;
                right_walk_edge_status = TURN_CLOCK_TARGET_YAW_LESS_ABS45_DETAL_YAW_MORE_30_COLLISION_RWE;
                break;
            }
            break;                                                                 
