...
typedef struct
{
	...
	uint8_t  infrared_charge1_status;   //12	回充红外状态1 		u16
	uint8_t  infrared_charge2_status;	//13	回充红外状态2 		u8
	uint8_t  infrared_charge3_status;	//13	回充红外状态3 		u8
	uint8_t  infrared_charge4_status;   //24    回充红外状态4 		u8
